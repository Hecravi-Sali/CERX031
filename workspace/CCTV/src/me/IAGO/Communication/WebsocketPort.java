...
public class WebsocketPort {
	...
	private StringBuffer packetmessage = new StringBuffer();
	...
	public void OnMessage(String message) {
	    ...
	    try {
            ...
            packetmessage.append(packet.getString("packetinfo"));
	        if(packet.getBoolean("end")) {
	            
	            JSONObject json = new JSONObject(packetmessage.toString());
	            packetmessage = new StringBuffer();
                ...
                case PORT_CONNECTCORE_CLOSE : {
                    if(_corename != null) {
                        ...
                        _corename = null;
                        _collectionmap.get(_uuid).SendMessage("Core close successful");
                    }
                    break;
                }
                default:
